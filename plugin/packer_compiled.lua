...
_G.packer_plugins = {
  ["auto-save.nvim"] = {
    ...
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/auto-save.nvim",
  ...
  delimitMate = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/delimitMate",
